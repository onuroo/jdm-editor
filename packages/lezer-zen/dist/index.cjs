...
const zenHighlight = highlight.styleTags({
  ...
  'CallbackReference': highlight.tags.self,
  'CompareOp': highlight.tags.compareOperator,
  ':': highlight.tags.punctuation,
  '( )': highlight.tags.paren,
  '[ ]': highlight.tags.squareBracket,
  '{ }': highlight.tags.brace,
  'InterpolationStart InterpolationEnd': highlight.tags.brace,
  '.': highlight.tags.derefOperator,
  ', ;': highlight.tags.separator,
});

// This file was generated by lezer-generator. You probably shouldn't edit it.
const spec_identifier = {__proto__:null,true:12, false:12, null:14, and:58, or:60};
